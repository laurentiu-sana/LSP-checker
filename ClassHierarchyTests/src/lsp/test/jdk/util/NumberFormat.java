...
import lsp.test.jdk.util.Currency;
...
public abstract class NumberFormat extends Format {
    ...
    public Number parse(String string) throws ParseException {
        ...
        if (pos.getIndex() == 0) {
            ...
            throw new ParseException("text.1D", pos.getErrorIndex()); //$NON-NLS-1$
        }
        return number;
    }
    ...
    public final Object parseObject(String string, ParsePosition position) {
        if (position == null) {
            ...
            throw new NullPointerException("text.1A"); //$NON-NLS-1$
        }
    ...
    private void readObject(ObjectInputStream stream) throws IOException,
        ...
        if (minimumIntegerDigits > maximumIntegerDigits
            ...
            throw new InvalidObjectException("text.00"); //$NON-NLS-1$
        }
        if (minimumIntegerDigits < 0 || maximumIntegerDigits < 0
                || minimumFractionDigits < 0 || maximumFractionDigits < 0) {
            // text.01=min or max digits negative
            throw new InvalidObjectException("text.01"); //$NON-NLS-1$
        }
    }
    ...
    public static class Field extends Format.Field {
        ...
        protected Object readResolve() throws InvalidObjectException {
            ...
            throw new InvalidObjectException("text.02"); //$NON-NLS-1$
        }
    }
