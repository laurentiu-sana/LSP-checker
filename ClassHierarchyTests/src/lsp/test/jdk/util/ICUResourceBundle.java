...
import lsp.test.jdk.util.ArrayList;
import lsp.test.jdk.util.Arrays;
import lsp.test.jdk.util.Collections;
import lsp.test.jdk.util.Enumeration;
import lsp.test.jdk.util.HashMap;
import lsp.test.jdk.util.HashSet;
import lsp.test.jdk.util.Locale;
import lsp.test.jdk.util.Map;
import lsp.test.jdk.util.MissingResourceException;
import lsp.test.jdk.util.ResourceBundle;
import lsp.test.jdk.util.Set;
...
public  class ICUResourceBundle extends UResourceBundle {
   ...
   /**
    ...
    private static final boolean DEBUG = false; //ICUDebug.enabled("localedata");
    ...
    private static ICUResourceBundle getBundle(Object reader, String baseName, String localeID, ClassLoader loader) {
/*
    ...
    protected UResourceBundle handleGet(String resKey, HashMap table, UResourceBundle requested) {
        ...
        if (res == null) {
            ...
            if (res != null && lookup != null && !alias[0]) {
                ...
                lookup.put(new Integer(index[0]), res);
            }
        }
        return res;
    }
