...
public abstract class Format implements Serializable, Cloneable {
    ...
    String convertPattern(String template, String fromChars, String toChars,
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (!quote && (index = fromChars.indexOf(next)) != -1) {
                ...
                throw new IllegalArgumentException("text.05"); //$NON-NLS-1$
            } else {
                output.append(next);
            }
        }
        if (quote) {
            ...
            throw new IllegalArgumentException("text.04"); //$NON-NLS-1$
        }
    ...
    public Object parseObject(String string) throws ParseException {
        ...
        if (position.getIndex() == 0) {
            ...
            throw new ParseException("text.1C", 0); //$NON-NLS-1$
        }
        return result;
    }
    ...
    static boolean upToWithQuotes(String string, ParsePosition position,
        ...
        throw new IllegalArgumentException("text.07"); //$NON-NLS-1$
    }
