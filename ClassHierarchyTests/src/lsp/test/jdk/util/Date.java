...
public class Date implements Serializable, Cloneable, Comparable<Date> {
    ...
    public static long parse(String string) {
        ...
        if (string == null) {
            ...
            throw new IllegalArgumentException("luni.06"); //$NON-NLS-1$
        }
    ...
    public String toGMTString() {
        SimpleDateFormat format1 = new SimpleDateFormat("d MMM "); //$NON-NLS-1$
        SimpleDateFormat format2 = new SimpleDateFormat(" HH:mm:ss 'GMT'"); //$NON-NLS-1$
